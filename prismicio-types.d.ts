...
type FrontpageDocumentDataSlicesSlice = BlogSlice | HeroSlice | RichTextSlice;
...
/**
 * Item in *Nav → Navigation*
 */
export interface NavDocumentDataNavigationItem {
  /**
   * link field in *Nav → Navigation*
   *
...
export interface BlogSliceDefaultPrimary {
  /**
   * Photo field in *Blog → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: blog.primary.photo
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  ...
  /**
   * Preview field in *Blog → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: blog.primary.preview
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  preview: prismic.RichTextField;

  /**
   * buttonlink field in *Blog → Primary*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: blog.primary.buttonlink
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  buttonlink: prismic.ContentRelationshipField;
}
